# Liste Complete des Skills Hermes Agent

> Date de creation: 2026-05-06
> Total: **103 skills** dans 17 categories
> Objectif: identifier les skills a supprimer pour economiser des tokens.
...
## Suggestions de suppression (gros gain de tokens)

### Supprimer sans risque (jamais utilises pour Clyro)
- **creative** (19 skills): `ascii-art`, `ascii-video`, `baoyu-comic`, `baoyu-infographic`, `comfyui`, `manim-video`, `p5js`, `pixel-art`, `pretext`, `songwriting-and-ai-music`, `touchdesigner-mcp`, `popular-web-designs` — sauf peut-etre `architecture-diagram`, `excalidraw`, `sketch`, `claude-design`, `humanizer`, `design-md`, `ideation`
- **mlops** (22 skills): TOUT le bloc ML si pas de fine-tuning prevu
- **smart-home**: `openhue` (si pas de Philips Hue)
- **social-media**: `xitter`, `xurl` (si pas de Twitter/X)
- **leisure**: `find-nearby`
- **red-teaming**: `godmode`
- **email**: `himalaya` (si pas configure)
- **research**: `blogwatcher`, `llm-wiki`, `polymarket`, `research-paper-writing`
- **mcp**: `mcporter`, `native-mcp` (si pas de serveurs MCP)
- **media**: `gif-search`, `heartmula`, `songsee`, `spotify`
- **productivity**: `airtable`, `google-workspace`, `linear`, `nano-pdf`, `notion`, `powerpoint`
- **data-science**: `jupyter-live-kernel`
- **autonomous-ai-agents**: `claude-code`, `codex`, `opencode` (si pas d'agents delegues)

### Garder absolument (essentiels pour Clyro)
- `coulson-knowledge-sop`
- `fury-competitor-monitor`
- `jarvis-ceo-agent`
- `hermes-agent`
- `obsidian`
- `obsidian-vault-sync`
- `nginx-ssl-hostinger-vps`
- `github-pr-workflow` / `github-repo-management` (pour le vault sync)
